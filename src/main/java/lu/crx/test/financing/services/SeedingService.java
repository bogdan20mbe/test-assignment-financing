    ...
    public void seedMasterData() {
        ...
        purchaser1 = Purchaser.builder()
                ...
                .purchaserFinancingSetting(PurchaserFinancingSettings.builder()
                        ...
                        .build())
                .build();
        purchaser1.getPurchaserFinancingSettings().forEach(pfs -> pfs.setPurchaser(purchaser1));
        ...
        purchaser2 = Purchaser.builder()
                ...
                .purchaserFinancingSetting(PurchaserFinancingSettings.builder()
                        ...
                        .build())
                .build();
        purchaser2.getPurchaserFinancingSettings().forEach(pfs -> pfs.setPurchaser(purchaser2));
        ...
        purchaser3 = Purchaser.builder()
                ...
                .purchaserFinancingSetting(PurchaserFinancingSettings.builder()
                        ...
                        .build())
                .build();
        purchaser3.getPurchaserFinancingSettings().forEach(pfs -> pfs.setPurchaser(purchaser3));
